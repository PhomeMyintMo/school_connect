...
if (isset($_GET["delete_id"])) {
    ...
    if ($status) {
        ...
        header("Location:../admin/post.php?success=$success");
    } else {
        $invalid = "Error Deleting!";
        header("Location:../admin/post.php?invalid=$invalid");
    }
}
...
<div class="container-fluid">
    ...
    $posts1 = get_all_post_with_users($mysqli);
    $posts2 = get_all_post_with_users($mysqli);
