...
if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($profile_img_file, "../upload/" . $profile_img_name)) {
        ...
        if ($status) {
            ...
            header("Location:../admin/accountsetting.php?success1=$success1");
        } else {
...
if (isset($_GET["delete_id"])) {
    if (file_exists($image)) {
        ...
        header("Location:../admin/accountSetting.php?success1=Image delete successful!");
    } 
}
        ...
        <div class="card" style="width:300px; height: 320px;">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class=" d-flex justify-content-between">
                    ...
                    <div class="col">
                    <a href="../admin/accountsetting.php?delete_id=<?php echo $user_id ?>" class="btn btn-outline-primary text-danger">Remove</a>
                </div>
                </div>
                ...
                <div class="col">
                    <?php if (isset($_GET['update_id'])) { ?>
                        <button class="btn btn-outline-primary border-1" name="submit" type="submit">Save
                            Changes</button>
                        <a type="button" class="btn btn-outline-primary border-1" href="../admin/accountsetting.php">Cancel</a>
                    <?php } else { 
                        if($cookie_user && $user_id === $cookie_user['user_id']) {
                        ?>
                        <a class="btn btn-outline-primary border-1" 
                        href="../admin/accountsetting.php?update_id=<?php echo $user_id ?>" role="button">Edit</a>
                    <?php } }?>
                </div>
            </div>
        </form>
