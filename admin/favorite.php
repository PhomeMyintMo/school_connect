    ...
    <div class="card my-5 p-4" style="width: 800px;">
        ...
        <div class="container">
            ...
            <div class="container" id="post">
                <?php
                $favorites = get_all_favorite_by_user_id($mysqli, $cookie_user['user_id']);
                $favorites1 = get_all_favorite_by_user_id($mysqli, $cookie_user['user_id']);

                if (count($favorites1->fetch_all()) == 0) {
                    ?>
                
                        <div class="container mb-4 d-flex justify-content-center">
                            <p>No Favorite Post Yet...
                            </p>
                        </div>
                ...
                while ($favorite = $favorites->fetch_assoc()) {
                    $post = get_post_by_id($mysqli, $favorite['post_id']);
                    $post_user_result = get_user_by_id($mysqli, $post['user_id']);
                    $post_user = $post_user_result->fetch_assoc();
                ?>
                            ...
                            <div class="card" style="width:500px;">
                                <div class="card-header bg-primary text-white">
                                    <nav class="navbar justify-content-between">
                                        ...
                                        <?php
                                        if ($cookie_user && $post_user['user_id'] === $cookie_user['user_id']) {
                                        ?>
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="form-group">
                                            <div class="row d-flex justify-content-center">
                                                <div class="col">
                                                <?php if ($post_user['is_admin']) { ?>
                                            <a href="../admin/profile.php?user_id=<?= $post_user['user_id'] ?>" class="text-decoration-none">
                                                <img class="img-profile rounded-circle" src="<?php
                                                                                                if ($post_user['image'] == null) {
                                                                                                    echo '../assets/img/profilepic.webp';
                                                                                                } else {
                                                                                                    echo $post_user['image'];
                                                                                                }
                                                                                                ?>" style="width:2rem;height:2rem;">&nbsp;
                                            </a>
                                        <?php } else { ?>
                                            <a href="../user/profile.php?user_id=<?= $post_user['user_id'] ?>" class="text-decoration-none">
                                                <img class="img-profile rounded-circle" src="<?php
                                                                                                if ($post_user['image'] == null) {
                                                                                                    echo '../assets/img/profilepic.webp';
                                                                                                } else {
                                        ...
                                        <span class="mr-2 d-lg-inline text-gray-600 small">
                                            <?php echo $post_user['user_name'];
                                            if ($post_user['is_admin']) {
