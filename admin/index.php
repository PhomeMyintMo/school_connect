...
<div class="container-fluid">
    ...
    <div class="container mb-4 d-flex justify-content-center">
        <div class="card" style="width: 500px;">
            ...
            <div class="p-4">
                <a href="../admin/profile.php" class="text-decoration-none">
                ...
                <a href="../admin/addpost.php" class="btn btn-primary">
    ...
    ?>
        ...
        <div class="container mb-4 d-flex justify-content-center">
            <p>No Result Found.......
            <i class="fa-regular fa-face-sad-tear fa-shake" style="color: grey;"></i>
            </p>
        </div>
