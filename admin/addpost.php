                    ...
                    <div class="p-4">
                        ...
                        <div class="form-group">
                            ...
                            <select id="category" name="category" class="form-control">
                                ...
                                <option value="event" class="form-control form-control-user">Event</option>
                                <option value="announcement" class="form-control form-control-user">Announcement</option>
                                <option value="post" class="form-control form-control-user">Post</option>
                            </select>
